...
try:
    ...
    print('Resource \'punkt\' not installed! Installing now...')
    nltk.download('punkt')
...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon_file=r"lexicon\common_en_lexicon.txt", emoji_lexicon=r"lexicon\emoji_utf8_lexicon.txt"):
